...
@Matches(
    (/^[a-z0-9]+(?:-[a-z0-9]+)*$/),{
        message:'A slug should be all small leters and uses only "-" and without spaces, For example "my-url"'
    }
)
slug:string;
...
@ApiPropertyOptional({
    description:"Serialize your json object else a vaidation error will be thrown",
